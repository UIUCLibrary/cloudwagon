...
def generate_default_toml_config(prompt_for_input: InputPrompt=input_prompt) -> str:
    main = tomlkit.table()
...
def write_default_config_file(file_name, config_file_strategy: Callable[[], str]) -> None:
