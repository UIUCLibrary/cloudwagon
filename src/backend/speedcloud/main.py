...
def create_default_config_file(args):
    config.write_default_config_file('config.toml', config_file_strategy=config.generate_default_toml_config)
...
def get_arg_parser() -> argparse.ArgumentParser:
    ...
    create_default_config_parser = subparsers.add_parser('create-default-config', help='create default config file')
